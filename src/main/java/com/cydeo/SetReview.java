...
public class SetReview {
    public static void main(String[] args) {
        //hashSet doesn't keep insertion order

        //1. create a set
        Set<Student> set = new LinkedHashSet<>();//linkedHashSet keep insertion order-no duplicates
    ...
    public static Character firstRepeatingChar(String str){
        ...
        //create a hashSet
        Set<Character>chars= new HashSet<>();//==in here I have Space Complexity of O(n)//created  another data structure
